...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Text = L"Введите время програва мусоровоза (мин)";
			// 
			// label5
			// 
			...
			this->CityType->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"Небольшой населенный пункт", L"Большой населенный пункт" });
...
#pragma endregion
	...
	private: System::Void raschet_Click(System::Object^ sender, System::EventArgs^ e) {
		datacalc^ dc = gcnew datacalc();// создаем новый экземпляр
		dc->Show(); // открываем вторую форму
		Calculationform::Hide();
	}
};
}
